...
<select
    ...
    x-init="
        ...
        $watch('country', async () => {let response = await axios.get(`/jurisdictions/${country}`); subdivisions = response.data; subdivision = ''});
    "
    x-model="subdivision"
>
        ...
        <template x-if="!Object.keys(subdivisions).length && country !== 'all'">
