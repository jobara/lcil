...
test('render create', function () {
    ...
    $toSee = [
        ...
        '<input  type="checkbox" name="decision_making_capability[]" id="decision-making-capability-independent" value="independent"',
        '<label for="decision-making-capability-independent">',
        'Independent',
        '<input  type="checkbox" name="decision_making_capability[]" id="decision-making-capability-interdependent" value="interdependent"',
        '<label for="decision-making-capability-interdependent">',
        'Interdependent',
        ...
        '<input x-model="courtChallenge" type="radio" name="court_challenge" id="court-challenge-not-related" value="not_related"',
        '<label for="court-challenge-not-related">',
        'Not related to a court challenge',
        '<input x-model="courtChallenge" type="radio" name="court_challenge" id="court-challenge-subject-to" value="subject_to"',
        '<label for="court-challenge-subject-to">',
        'Is or has been subject to a constitutional or other court challenge',
        '<input x-model="courtChallenge" type="radio" name="court_challenge" id="court-challenge-result-of" value="result_of"',
        '<label for="court-challenge-result-of">',
        ...
        '<input  type="checkbox" name="decision_type[]" id="decision-type-personal-life-care" value="personal_life_care"',
        '<label for="decision-type-personal-life-care">',
        'Personal Life and Care',
        '<input  type="checkbox" name="decision_type[]" id="decision-type-healthcare" value="healthcare"',
        '<label for="decision-type-healthcare">',
        'Health Care',
        '<input  type="checkbox" name="decision_type[]" id="decision-type-financial-property" value="financial_property"',
        '<label for="decision-type-financial-property">',
