...
test('render - all values - guest', function () {
    ...
    $toSee = [
        ...
        htmlentities($regimeAssessment->lawPolicySources[0]->name),
        htmlentities($regimeAssessment->lawPolicySources[1]->name),
        htmlentities($regimeAssessment->lawPolicySources[2]->name),
        'Modified:',
        $date,
        'Created:',
        $date,
