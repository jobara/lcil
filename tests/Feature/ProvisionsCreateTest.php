...
test('create route render', function () {
    ...
    $toSee = [
        ...
        '<input x-model="courtChallenge" type="radio" name="court_challenge" id="court_challenge-not_related" value="not_related"',
        '<label for="court_challenge-not_related">',
        'Not related to a court challenge.',
        '<input x-model="courtChallenge" type="radio" name="court_challenge" id="court_challenge-result_of" value="result_of"',
        '<label for="court_challenge-result_of">',
        'Is or has been subject to a constitutional or other court challenge',
        '<input x-model="courtChallenge" type="radio" name="court_challenge" id="court_challenge-subject_to" value="subject_to"',
